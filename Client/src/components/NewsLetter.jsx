...
export default function NewsLetter(){
    return(
        ...
        <div className="flex flex-col items-center mt-28  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            
            <Title title="Stay in the Loop" subTitle="Get exclusive travel deals, insider tips, and destination inspiration—straight to your inbox."/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                    <img src={assets.arrowIcon} alt="arrw icon " className="w-3.5 invert group-hover:translate-x-1 transition-all" />
                </button>
            </div>
